...
**使用**
```
docker pull mylolis/dns
docker container stop dns ; docker container rm dns
docker run -d --net=host --restart=always --name dns -v ~/.gsmartdns:/smartdns mylolis/dns
docker restart dns
```
